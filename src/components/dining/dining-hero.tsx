...
import { DINING_HERO } from "@/lib/content/dining";
import { RevealHeading } from "@/components/ui/reveal-heading";
import { useMoveY, useImageScale } from "@/hooks/use-animations";

/**
 * Dining hero — ports `section_hero_big_image`: full-width image with an
 * overlay, a `title-stagger` title, and a `move-y` sub-copy entrance on load,
 * plus a slow `image-scale` on the background.
 */
