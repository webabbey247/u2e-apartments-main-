...
export const ESSENTIALS = {
  ...
  items: [
    "Central location, within walking distance of the city's business, dining, and cultural districts.",
...
export const UPCOMING_EVENTS = {
  ...
  body: "From cozy dinners to joyful celebrations, there's always something happening at U2E. Grab your spot early, because these moments tend to fill up fast!",
  items: [
    {
...
export const EVENTS_FEATURE = {
  ...
  body: "We host responsibly. Sustainable sourcing, minimal waste, and genuine care for our guests and community run through every event we put on.",
  cta: { label: "Make an Enquiry", href: "#enquiry" },
